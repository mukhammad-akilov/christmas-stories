...
const DeviceInfoPrivacyPolicy = () => {
  useEffect(() => {
    // Set page title
    document.title = `Device Info Privacy Policy`;
  }, []);

  return (
    <div className={styles.contentContainer}>
      <h1 className={styles.title}>Privacy Policy Akilov.dev</h1>
      <h2 className={styles.subtitle}>Privacy Policy "Device Info"</h2>
      <p>
        Akilov.dev built the Device INfo app as a Free app. This SERVICE is
...
export default DeviceInfoPrivacyPolicy;
